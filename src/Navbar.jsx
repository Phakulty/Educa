...
const Navbar = () => {
  ...
  return (
    <header className="bg-[#ddd] shadow-md py-4">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <nav
          ...
          } fixed top-0 left-0 w-64 h-full bg-[#ddd] shadow-lg z-50 transform transition-transform duration-300 ease-in-out md:static md:w-auto md:translate-x-0 md:flex md:items-center`}
        >
